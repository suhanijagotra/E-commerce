  ...
  return (
    <div className='flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center py-20 text-xs sm:text-sm md:text-base text-gray-700'>
      ...
      <div>
        ...
        <img src="{asssets.exchange_icon}" className='w-12 m-auto mb-5' alt="" />
      ...
      <div>
        ...
        <img src="{asssets.quality_icon}" className='w-12 m-auto mb-5' alt="" />
      ...
      <div>
        ...
        <img src="{asssets.support_img}" className='w-12 m-auto mb-5' alt="" />
